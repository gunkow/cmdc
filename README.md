...
| **Provider Settings…** | Opens the interactive settings window to choose providers, select or enter models, set API keys, custom endpoints, thinking levels, and symbol replacement. Remembers individual settings per provider. |
